...
First, the previous research usually focused on how to reduce the rehandles or shifts , out paper initially considers how to get the optimal container stowage plan when giving the allowed number of rehandles.
...
Therefore, we can get the different results when the value of K is different, and zero rehandle can be a benchmark for others to compare with.
