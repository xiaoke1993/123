...
\section{Recent work}
\label{sec:weibo:lr}
As a response to the complications faced by traditional finance theories, behavioral finance has emerged as a new approach in financial markets.
{\color{red}{For example, Herding behavior described in \cite{yousaf2018herding} in stock market is a typical phenomenon of behavioral finance}}
...
In general, behavioral finance argues that some financial phenomena can be better apprehended under the assumption that some players are not fully rational. More definitely, it investigates what happens when tenets that underlied individual rationality are relaxed \cite{Barberis2002}. Behavioral finance has provided proofs that financial decisions are significantly driven by emotions and moods \cite{Nofsinger2005}. Recent study in behavioral economics shows that stock markets are driven by ``fear and greed" {\color{red}{\citep{Westerhoff2012Greed,Bill2013Greed,jansen2016fear}}}.
