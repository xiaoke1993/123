...
These areas are termed as 20-ft bays. Figure \ref{fig 1:graph} (reproduce from \cite{Delgado2012251}) shows a diagram of containership.
\begin{figure}[htbp]
\center
...
Most of previous research on stowage planning focus on how to minimize the number of rehandles (todo).
In this paper, we investigate the problem from another perspective; we pay our attention on the number of stacks used. In the real world, a carrier/forwarder may collect partial containers and want to evaluate the space (stacks) they occupy. If occupied stacks can be evaluated, how much space can be reserved for future containers. Hence, they need an indicator to evaluate. todo

ignores the importance of the capacity of ship and give much emphasis on the balance of ship, the number of rehandle and so on.
...
%  5	&50&	7&	5&	6.8&	5&	9.8&	5&	9.6&	5&	8.2&	5&	9.4&	5&	9&\\
