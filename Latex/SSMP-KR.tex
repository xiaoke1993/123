...
Standard containers are shipped along the journey.
Since the route is circular, some containers are shipped from $i$ to $j$ ($i<j$) and some containers are shipped from $i$ to $j$ ($i>j$) going across port 1.
...
In this paper, we extend SSMP with zero rehandle \citep{wang2014stowage}, assuming that $K$ rehandles are allowed.

TODO: other assumption
