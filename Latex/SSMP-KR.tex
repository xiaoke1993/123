...
& \mathrm{s.t.}\hspace{11pt}\sum_{i=1}^{P} \le K \label{eqn:1}\\
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.00in,height=3.00in]{without rehandle.png}
\caption{a side view of a partially loaded stack.}
\label{fig three:graph}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.00in,height=3.00in]{with rehandle.png}
\caption{a side view of a partially loaded stack.}
\label{fig three:graph}
\end{figure}
